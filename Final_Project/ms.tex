...
\begin{table}[h]
  ...
  \caption {Posterior distirbutions of parameters in the
    wCDM model. Uncertainties denote symmetrized 68\%
    confidence intervals maginalized over other parameters.}
\end{table}

\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/betoule_wcdm_noprior_corner.eps}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/betoule_wcdm_withprior_corner.eps}
  \caption{Posterior distributions of the cosmological parameters in the
