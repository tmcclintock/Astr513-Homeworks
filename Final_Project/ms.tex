...
\citet{betoule2014} define their ``joint light-curve analysis'' (JLA) sample, a total of 740 type Ia supernovae (SNe Ia) %If we define the abbreviations elsewhere, this can change -- ELW
