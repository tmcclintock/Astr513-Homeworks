...
observed by the \Planck analysis, as seen in figure 3.
%\autoref{fig:planck_corner}
\TM{The autoref isn't working here. If someone can figure it out put it back in.}

\begin{figure}
  \label{fig:planck_corner}
  \centering
  \includegraphics[width=0.6\linewidth]{figures/corner_example.eps}
  \caption{\TM{THIS IS A PLACE HOLDER PLOT!}
    Posterior distributions of the cosmological parameter
...
CAMB, the \Planck likelihood code (our priors), and our {\sn} likelihood 
...
\EW{Filler table for the lambda CDM fits}
\begin{table}[h]
   \centering
    \begin{tabular}{l|cc}
    ~                          & $\Omega_m$ & $h$ \\ \hline
    ...
    \end{tabular}
    \caption {\label{tab:lcdm}Posterior distirbutions of parameters in the
      $\Lambda$CDM model. uncertainties denote symmetrized 68\%
      confidence intervals maginalized over other parameters.}
\end{table}

\EW{Just a filler for the table for the wCDM fits}
\begin{table}[h]
  \label{tab:wcdm}
  \centering
  \begin{tabular}{l|ccc}
  ...
  \end{tabular}
  \caption {Posterior distirbutions of parameters in the
    wCDM model for both data sets and the \Planck likelihood only. 
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{figures/betoule_wcdm_noprior_corner.eps}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{figures/betoule_wcdm_withprior_corner.eps}
  \caption{Posterior distributions of the cosmological parameters in the
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{figures/betoule_lcdm_noprior_corner.eps}
  \caption{Posterior distributions of the cosmological parameters in the
    analysis of the \citet{betoule2014} data without including the
    \Planck priors for a $\Lambda$CDM model. Contours denote the
    68\% and 95\% confidence projected areas; dashed lines in
    the 1D histograms refer to the 68\% confidence intervals.}
  \label{fig:betoule_lcdm_noprior_corner}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{figures/betoule_lcdm_withprior_corner.eps}
  \caption{Posterior distributions of the cosmological parameters in the
    analysis of the \citet{betoule2014} data including the
    \Planck priors for a $\Lambda$CDM model. Contours denote the
    68\% and 95\% confidence projected areas; dashed lines in
    the 1D histograms refer to the 68\% confidence intervals.}
  \label{fig:betoule_lcdm_withprior_corner}
\end{figure}
