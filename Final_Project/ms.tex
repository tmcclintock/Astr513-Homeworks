...
\begin{figure}
  ...
  \caption{Same as ~\autoref{fig:betoule_wcdm_corner} but with the \citet{rest2014} data.}
  \label{fig:rest_wcdm_corner}
\end{figure}
%
\EW{Wasn't sure where to put the \Planck only corner plot}
\begin{figure}
  \centering
  \includegraphics[width=0.5\linewidth]{figures/nosn_wcdm_corner.eps}
  \caption{Same as ~\autoref{fig:betoule_wcdm_corner} and ~\autoref{fig:rest_wcdm_corner}, but using only \Planck likelihoods without \sn{} data.}
  \label{fig:nosnia_wcdm_corner}
\end{figure}
%
\begin{figure}
  ...
  \caption{Posterior distributions of the cosmological parameters in the
    analysis of the \citet{betoule2014} data for a $\Lambda$CDM model. The left is without 
    \Planck priors and the right is with \Planck priors. Contours denote the
    68\% and 95\% confidence projected areas; dashed lines in
    the 1D histograms refer to the 68\% confidence intervals.}
